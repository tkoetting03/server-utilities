...
public final class TextStylePanelLayout {
	...
	private static final Component SOLID = Component.translatable("screen.hologrammenu.text_style.apply_color");
	private static final Component GRADIENT = Component.translatable("screen.hologrammenu.text_style.apply_gradient");
	private static final Component RESET = Component.translatable("screen.hologrammenu.text_style.reset");
	...
	public static Metrics metrics(int partCount, int contentTopOffset, boolean gradientExpanded, boolean partsCollapsed) {
		...
		List<Component[]> effectRows = List.of(
			new Component[] {
				Component.translatable("screen.hologrammenu.text_style.effect.bold"),
				Component.translatable("screen.hologrammenu.text_style.effect.underline"),
				Component.translatable("screen.hologrammenu.text_style.effect.italic")
			},
			new Component[] {
				Component.translatable("screen.hologrammenu.text_style.effect.strikethrough"),
				Component.translatable("screen.hologrammenu.text_style.effect.obfuscated")
			}
		);
