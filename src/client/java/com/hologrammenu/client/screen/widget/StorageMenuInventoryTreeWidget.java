...
import com.hologrammenu.client.screen.StorageMenuInventoryTree;
...
public class StorageMenuInventoryTreeWidget extends AbstractWidget {
	...
	public StorageMenuInventoryTreeWidget(int x, int y, int height, List<StorageMenuInventoryTree.Node> nodes) {
		super(x, y, PANEL_WIDTH, height, Component.translatable("screen.hologrammenu.storage_menu.inventory_tree"));
		this.nodes = nodes;
		this.active = false;
	}
