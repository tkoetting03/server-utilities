...
import com.hologrammenu.client.screen.NpcOptionsScreen;
...
public final class NpcClientEditInteractions {
	...
	private static InteractionResult openOptionsScreen(Entity entity) {
		...
		if (!StorageMenuClientPermissions.canEdit()) {
			client.player.sendOverlayMessage(Component.translatable("screen.hologrammenu.npc_options.no_permission"));
			return InteractionResult.FAIL;
		}
		if (!NpcHelper.canEdit(client.player, entity)) {
			client.player.sendOverlayMessage(Component.translatable("screen.hologrammenu.npc_options.too_far"));
			return InteractionResult.FAIL;
		}
