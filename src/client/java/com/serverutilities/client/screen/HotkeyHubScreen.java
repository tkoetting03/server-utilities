...
import com.serverutilities.client.HotkeyActions;
...
public class HotkeyHubScreen extends Screen {
	...
	public HotkeyHubScreen() {
		super(Component.translatable("screen.serverutilities.hotkey_hub.title"));
	}
	...
	protected void init() {
		...
		addRenderableWidget(createToggleButton(
			...
			"screen.serverutilities.hotkey_hub.npc_placement",
		...
		addRenderableWidget(createToggleButton(
			x, y, buttonWidth, buttonHeight,
			"screen.serverutilities.hotkey_hub.npc_edit",
		...
		addRenderableWidget(createToggleButton(
			x, y, buttonWidth, buttonHeight,
			"screen.serverutilities.hotkey_hub.hologram_placement",
		...
		addRenderableWidget(createToggleButton(
			x, y, buttonWidth, buttonHeight,
			"screen.serverutilities.hotkey_hub.hologram_edit",
		...
		addRenderableWidget(VanillaIconButton.create(
			x, y, buttonWidth, buttonHeight,
			Component.translatable("screen.serverutilities.item_styler.title"),
		...
		addRenderableWidget(createToggleButton(
			x, y, buttonWidth, buttonHeight,
			"screen.serverutilities.hotkey_hub.style_widget",
		...
		addRenderableWidget(createToggleButton(
			x, y, buttonWidth, buttonHeight,
			"screen.serverutilities.hotkey_hub.storage_placement",
		...
		addRenderableWidget(createToggleButton(
			x, y, buttonWidth, buttonHeight,
			"screen.serverutilities.hotkey_hub.container_editor_widget",
	...
	private int hubButtonWidth() {
		return Math.min(
			...
			maxIconButtonWidth(
				toggleLabel("screen.serverutilities.hotkey_hub.hologram_placement", true),
				toggleLabel("screen.serverutilities.hotkey_hub.hologram_placement", false),
				toggleLabel("screen.serverutilities.hotkey_hub.storage_placement", true),
				toggleLabel("screen.serverutilities.hotkey_hub.storage_placement", false),
				toggleLabel("screen.serverutilities.hotkey_hub.npc_placement", true),
				toggleLabel("screen.serverutilities.hotkey_hub.npc_placement", false),
				toggleLabel("screen.serverutilities.hotkey_hub.npc_edit", true),
				toggleLabel("screen.serverutilities.hotkey_hub.npc_edit", false),
				toggleLabel("screen.serverutilities.hotkey_hub.hologram_edit", true),
				toggleLabel("screen.serverutilities.hotkey_hub.hologram_edit", false),
				Component.translatable("screen.serverutilities.item_styler.title"),
				toggleLabel("screen.serverutilities.hotkey_hub.style_widget", true),
				toggleLabel("screen.serverutilities.hotkey_hub.style_widget", false),
				toggleLabel("screen.serverutilities.hotkey_hub.container_editor_widget", true),
				toggleLabel("screen.serverutilities.hotkey_hub.container_editor_widget", false),
				Component.translatable("gui.done")
			)
		);
	}
	...
	private static Component toggleLabel(String labelKey, boolean enabled) {
		return Component.translatable(
			enabled ? "screen.serverutilities.hotkey_hub.toggle_on" : "screen.serverutilities.hotkey_hub.toggle_off",
	...
	public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
		...
		UiScaleText.drawCentered(
			graphics,
			this.font,
			Component.translatable("screen.serverutilities.hotkey_hub.hint"),
			panelX + panelWidth / 2,
			y + UiScale.s(14),
			0xA0A0A0
		);
		y += HEADER_HEIGHT;
		y = drawGroupLabel(graphics, contentLeft, contentWidth, y, Component.translatable("screen.serverutilities.hotkey_hub.group.npc"));
		y += buttonHeight + rowGap + buttonHeight + sectionGap;
		y = drawGroupLabel(graphics, contentLeft, contentWidth, y, Component.translatable("screen.serverutilities.hotkey_hub.group.hologram"));
		y += buttonHeight + rowGap + buttonHeight + sectionGap;
		y = drawGroupLabel(graphics, contentLeft, contentWidth, y, Component.translatable("screen.serverutilities.hotkey_hub.group.style"));
		y += buttonHeight + rowGap + buttonHeight + sectionGap;
		drawGroupLabel(graphics, contentLeft, contentWidth, y, Component.translatable("screen.serverutilities.hotkey_hub.group.container"));
	}
