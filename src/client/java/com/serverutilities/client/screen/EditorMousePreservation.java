...
import com.serverutilities.client.mixin.accessor.MouseHandlerAccessor;
...
public final class EditorMousePreservation {
	...
	private static void restoreNow() {
		...
		accessor.serverutilities$setXpos(savedX);
		accessor.serverutilities$setYpos(savedY);
		accessor.serverutilities$setIgnoreFirstMove(true);
	}
}
