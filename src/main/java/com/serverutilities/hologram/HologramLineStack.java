...
public final class HologramLineStack {
	...
	public static final String GROUP_TAG_PREFIX = "serverutilities:hologram_group:";
	public static final String LINE_INDEX_TAG_PREFIX = "serverutilities:hologram_line:";
	public static final String GROUP_HEIGHT_TAG_PREFIX = "serverutilities:hologram_group_height:";
	public static final String LINE_HEIGHT_TAG_PREFIX = "serverutilities:hologram_line_height:";
	...
	public static List<Line> readGroup(List<Display.TextDisplay> displays) {
		...
		List<Line> baseLines = sorted.stream()
			.map(display -> new Line(
				TextFormats.fromComponent(((TextDisplayAccessor) display).serverutilities$getText()),
