...
public final class HologramScale {
	...
	private static final String SCALE_PREFIX = "serverutilities:hologram_scale:";
	private static final String LEGACY_TEXT_SCALE_PREFIX = "serverutilities:text_scale:";
	...
	public static void apply(Display display, float scale) {
		...
		Transformation current = DisplayAccessor.serverutilities$createTransformation(display.getEntityData());
		...
		((DisplayAccessor) display).serverutilities$setTransformation(updated);
	}

	public static float readUniformScale(Display display) {
		Transformation transformation = DisplayAccessor.serverutilities$createTransformation(display.getEntityData());
