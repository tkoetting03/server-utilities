...
public final class NpcHologramStack {
	...
	private static final String STACK_TAG_PREFIX = "hologrammenu:npc_holo_stack:";
	private static final String STYLED_NAME_TAG_PREFIX = "hologrammenu:npc_styled_name:";
	...
	public static float clampScale(float scale) {
		return com.hologrammenu.hologram.HologramScale.clamp(scale);
	}
